...
This project uses the COCO dataset classes, containing 80 common object categories such as person, car, dog, cat, airplane, and banana. It uses YOLOv11 for fast and accurate real-time object detection. The model predicts object classes, bounding boxes, and confidence scores, which are converted into searchable metadata for efficient image retrieval and dataset exploration.
